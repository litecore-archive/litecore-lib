Contributing to florincore
=======

We're working hard to make *florincore* the most powerful JavaScript library for working with florincoin. Our goal is to have *florincore* be a library that can be used by anyone interested in florincoin, and to level expertise differences with great design and documentation.
...
These are some global design goals in florincore that any change must adhere.
...
When possible, florincore objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of florincore methods. For example, calling `JSON.stringify` on a florincore object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
#### T3 - Require 'florincore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the florincore object.

DO:
```javascript
var florincore = require('../');
var PublicKey = florincore.PublicKey;
```
DON'T:
```javascript
...
```sh
git remote add akhil2015 git@github.com:akhil2015/florincore.git
git pull --rebase akhil2015 master
```
...
```
Finally go to [github.com/akhil2015/florincore](https://github.com/akhil2015/florincore) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of florincore.

If you have any questions feel free to post them to
[github.com/akhil2015/florincore/issues](https://github.com/akhil2015/florincore/issues).
