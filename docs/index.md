...
* [Peer to Peer Networking](https://github.com/litecoin-project/bibecore-p2p)
...
var imported = bibecore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new bibecore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new bibecore.URI(paymentInfo).toString();
```
