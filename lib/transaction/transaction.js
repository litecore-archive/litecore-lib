...
Transaction.MAX_MONEY = 600000000 * 1e8; // Bibecoin has 600M coins
...
Transaction.FEE_PER_KB = 100000; // Litecoin default fees is 0.001 BIBE
 ...
 * and a slightly fancier format recognized by bibecore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a bibecore Address object. The
 * same is true for `script`, which can be a string or a bibecore Script.
 *
